...
def inferBuildSteps(listing, repo):
    ...
    base_c_def = {
        ...
        'grep test': "",
        'grep env': "",
        'build': "if [ -x configure ]; then ./configure > build_result.arti; fi; make clean >> build_result.arti; make all >> build_result.arti",
        'test' : "make test > test_result.arti",
        'env' : "",
    ...
    base_java_def = {
        ...
        'grep test': "",
        'grep env': "",
        'build': "if [ -e pom.xml ]; then mvn clean compile > build_result.arti; elif [ -e build.xml ]; then ant > build_result.arti; elif [ -e build.gradle ]; then gradle -q > build_result.arti; fi",
        'test': "if [ -e pom.xml ]; then mvn test -fn > test_result.arti; elif [ -e build.xml ]; then ant test > test_result.arti; elif [ -e build.gradle ]; then gradle -q test > test_result.arti; fi",
        'env' : "",
        'artifacts': "",                        # TODO: Need to specify a build artifact
        'reason': "primary language",
        'error': "",
    ...
    ant_def = {
        'build system': "ant",
        'primary lang': "Java",
        'grep build': "ant clean > build_result.arti; ant >> build_result.arti",
        'grep test': "ant test > test_result.arti",
        'grep env': "ANT_OPTS",
        'build': "ant",
        'test' : "ant test",
        'env' : "",
    ...
    maven_def = {
        ...
        'grep test': "",
        'grep env': "MAVEN_OPTS",
        'build': "mvn dependency:list -DexcludeTransitive > build_result.arti; mvn clean compile >> build_result.arti",
    ...
    c_def = {
        ...
        'grep test': "make test",
        'grep env': "",
        'build': "if [ -x configure ]; then ./configure > build_result.arti; fi; make clean >> build_result.arti; make >> build_result.arti",
        'test' : "make test > test_result.arti",
        'env' : "",
        'artifacts': "",                        # TODO: Need to specify a build artifact
        'reason': "Makefile",
    ...
    buildsh_def = {
        ...
        'grep env': "",
        'build': "./build.sh > build_result.arti",
        'test' : "./build.sh test > test_result.arti",
        'env' : "",
        'artifacts': "",
        'reason': "build.sh",
        'error': "",
