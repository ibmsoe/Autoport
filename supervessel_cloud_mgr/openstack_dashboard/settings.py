...
# SITE_BRANDING = "SuperVessel Cloud Management"
SITE_BRANDING = "AutoPort"
...
STATIC_URL = '/autoport/static/'
GEOIP_PATH = os.path.abspath(os.path.join(STATIC_ROOT, 'geoip'))
...
CELERY_IMPORTS = (
    'openstack_dashboard.celery.beat.operation',
    'openstack_dashboard.celery.beat.nova',
    'openstack_dashboard.celery.task.user_operation',
    'openstack_dashboard.celery.task.nova')
