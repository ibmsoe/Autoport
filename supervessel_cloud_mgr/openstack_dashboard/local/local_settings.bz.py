...
OPENSTACK_CONFIG_BACKEND = {
    'configs': [{'region': 'HangZhou',
                ...
                {'region': 'Beijing',
                 ...
                 'gpu_zone': "op-cp15-ppc-gpu-LE-docker",
                 'vlan_name': 'net-vlan1'},
                ],
    'user': 'admin',
    'password': 'p0weradm1n',
...
REGIONS = [
    ('http://192.168.12.51:5000/v2.0', 'HangZhou'),
#    ('http://192.168.12.51:5000/v2.0', 'Beijing'),
#    ('http://crl.ptopenlab.com:5000/v2.0', 'Beijing'),
]
# MICHAEL HINES MODIFIED
#OPENSTACK_HOST = "crl.ptopenlab.com"
OPENSTACK_HOST = "172.17.140.148"
#OPENSTACK_HOST = "182.92.229.136"
