...
class AddRule(forms.SelfHandlingForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['from_port'].widget = forms.HiddenInput()
        self.fields['to_port'].widget = forms.HiddenInput()
        self.fields['security_group'].widget = forms.HiddenInput()
        self.fields['ip_protocol'].widget = forms.HiddenInput()
        self.fields['icmp_type'].widget = forms.HiddenInput()
        self.fields['icmp_code'].widget = forms.HiddenInput()
        self.fields['ethertype'].widget = forms.HiddenInput()
