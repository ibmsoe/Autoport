...
from openstack_dashboard.dashboards.project.access_and_security.security_groups import views as sec_views


urlpatterns = patterns('',
    # url(r'^$', views.IndexView.as_view(), name='index'),
    url(r'^$', sec_views.DetailView.as_view(), name='index'),
