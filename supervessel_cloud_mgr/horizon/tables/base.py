...
class DataTableOptions(object):
    ...
    def __init__(self, options):
        ...
        self.table_class = getattr(options, 'table_class', None)
        self.table_id = getattr(options, 'table_id', None)
        ...
        self.table_actions_template = getattr(options,
...
class DataTable(object):
    ...
    @property
    def table_actions_template(self):
        return self._meta.table_actions_template
