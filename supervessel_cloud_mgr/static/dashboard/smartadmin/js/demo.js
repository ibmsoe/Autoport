...
//    .append('<div class="demo"><span id="demo-setting"><i class="fa fa-cog txt-color-blueDark fa-spin"></i></span> <form><legend class="no-padding margin-bottom-10">'+gettext("Layout Options")+'</legend><section><label><input name="subscription" id="smart-fixed-header" type="checkbox" class="checkbox style-0"><span>'+gettext("Fixed Header")+'</span></label><label><input type="checkbox" name="terms" id="smart-fixed-navigation" class="checkbox style-0"><span>'+gettext("Fixed Navigation")+'</span></label><label><input type="checkbox" name="terms" id="smart-fixed-ribbon" class="checkbox style-0"><span>'+gettext("Fixed Ribbon")+'</span></label><label><input type="checkbox" name="terms" id="smart-fixed-footer" class="checkbox style-0"><span>'+gettext("Fixed Footer")+'</span></label><label><input type="checkbox" name="terms" id="smart-fixed-container" class="checkbox style-0"><span>'+gettext("Inside <b>.container</b>")+'</span></label><label style="display:block;"><input type="checkbox" id="smart-topmenu" class="checkbox style-0"><span>'+gettext("Menu on <b>top</b>")+'</span></label></section></form> </div>');
