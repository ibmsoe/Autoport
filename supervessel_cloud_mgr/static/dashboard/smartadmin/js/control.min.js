...
else{alert("There was an error loading script: "+src);}}}
...
else{elem["on"+sType]=fn;}}};if("undefined"!=typeof(console)&&"undefined"!=typeof(console.log)){CJS.dprint=function(msg){console.log("CJS "+Number(new Date())+": "+msg);};}
